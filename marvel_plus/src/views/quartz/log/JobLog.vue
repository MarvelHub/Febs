            ...
            <a-table ref="TableInfo"
                ...
                <template slot="params" slot-scope="text, record">
                    <a-popover placement="topLeft">
                        ...
                        <p style="margin-bottom: 0">{{text!=null?text.substring(0,40):text}}</p>
                    </a-popover>
                </template>
