            ...
            <a-col :span="16" >
                <a-form layout="inline" class="operator-left">
                    ...
                    <a-form-item label="创建时间">
                        <range-date @change="handleDateChange" ref="createTime"/>
                    </a-form-item>
                </a-form>
            </a-col>
            <a-col :span="8" >
                <div class="operator-right">
                    ...
                    <a-button v-hasPermission="'role:add'" @click="add">新增</a-button>
...
<script>
    ...
    export default {
        name: 'Role',
        components: {ACol, ARow, RangeDate, RoleInfo, RoleAdd, RoleEdit},
        data() {
            return {
                advanced: false,
                roleInfo: {
