<template>
    <a-card :bordered="false" class="card-area">
        ...
        <div>
            <a-row>
                <a-col :span="16">
                    <a-form layout="inline" class="operator-left">
                ...
                <a-col :span="8">
                    <div class="operator-right">
                        ...
                        <a-popconfirm title="请选择创建类型" okText="按钮" cancelText="菜单"
                                      @cancel="() => createMenu()" @confirm="() => createButton()">
                            <a-icon slot="icon" type="question-circle-o" style="color: orangered"/>
                            <a-button v-hasPermission="'menu:add'">新增</a-button>
                        </a-popconfirm>
        ...
        <div>
            <!-- 表格区域 -->
            <a-table :columns="columns" :key="key" :dataSource="dataSource" :pagination="pagination" :loading="loading"
                     :rowSelection="{selectedRowKeys: selectedRowKeys, onChange: onSelectChange}"
                     @change="handleTableChange" :scroll="{x : 1250}">
