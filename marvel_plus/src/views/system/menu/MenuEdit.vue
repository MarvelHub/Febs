<template>
    <a-modal title="修改菜单" :centered="true" :keyboard="false" :closable="false"
             :footer="null" :visible="menuEditVisiable" :width="620">
        <a-form :form="form">
            ...
            <a-form-item label='菜单图标' v-decorator="['icon']"
                         v-bind="formItemLayout">
            ...
            <a-form-item label='上级菜单' v-bind="formItemLayout">
                <div class="inner">
                    <a-tree ref="menuTree" :key="menuTreeKey" :checkable="true" :checkStrictly="true" class="innerbox" style="height: 250px"
