<template>
  <a-modal title="新增按钮" :centered="true" :keyboard="false" :closable="false"
           :footer="null" :visible="buttonEditVisiable" :width="620">
    <a-form :form="form">
      ...
      <a-form-item label='上级菜单' v-bind="formItemLayout">
        <div class="inner">
          <a-tree :key="menuTreeKey" :checkable="true" :checkStrictly="true" @check="handleCheck" class="innerbox" style="height: 250px"
                  @expand="handleExpand" :expandedKeys="expandedKeys" :defaultCheckedKeys="defaultCheckedKeys" :treeData="menuTreeData"/>
        </div>
      </a-form-item>
    </a-form>
