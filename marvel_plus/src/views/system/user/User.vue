<template>
    <a-card :bordered="false" class="card-area">
        <a-row>
            <a-col :span="16" style="float: left">
                <div :class="advanced ? 'search' : null">
                    ...
                    <a-form layout="inline" style="float: left">
                        ...
                        <a-form-item>
                            <dept-input-tree @change="handleDeptChange" ref="deptTree" style="width: 200px"
                                             placeholder="部门"/>
                        </a-form-item>
                        <a-form-item>
                        ...
                        <a-form-item>
                            <a-select v-model="queryParams.ssex" style="width: 120px">
                                <a-icon slot="suffixIcon" type="caret-down"/>
            ...
            <a-col :span="8" style="float: right">
                <div class="operator">
                    <a-button @click="search" icon="search" title="查询" />
                    <a-button @click="reset" icon="redo" title="重置"/>
                    <a-button @click="add" v-hasPermission="'user:add'">新增</a-button>
                    ...
                    <a-dropdown v-hasAnyPermission="'user:reset','user:export'">
                        ...
                        <a-menu slot="overlay">
                            <a-menu-item v-hasPermission="'user:reset'" key="password-reset" @click="resetPassword">
                                密码重置
                            </a-menu-item>
                            <a-menu-item v-hasPermission="'user:export'" key="export-data" @click="exportExcel">
                                导出Excel
                            </a-menu-item>
                        </a-menu>
...
<script>
    ...
    import DeptInputTree from '@/components/DeptInputTree'
    ...
    export default {
        name: 'User',
        components: {ACol, AFormItem, UserInfo, UserAdd, UserEdit, DeptInputTree},
        data() {
            return {
                advanced: false,
                userInfo: {
