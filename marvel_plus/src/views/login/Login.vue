        ...
        <a-col :span="5" :offset="9">
            <div class="login">
                <a-form @submit.prevent="doLogin" :autoFormCreate="form => (this.form = form)">
                    <a-tabs size="large" :tabBarStyle="{ textAlign: 'center' }" style="padding: 0 2px;" :activeKey="activeKey" @change="handleTabsChange" >
                    ...
                    <a-form-item>
                        <a-button :loading="loading" style="width: 100%; margin-top: 4px"
                                  size="large" htmlType="submit" type="primary">
                            登录
                        </a-button>
                    </a-form-item>
                    <div><a style="float: right" @click="regist">注册账户</a></div>
                </a-form>
            </div>
        </a-col>
    </a-row>
