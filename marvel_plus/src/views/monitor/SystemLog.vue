    ...
    <a-card :bordered="false" class="card-area">
        <table-header-search>
            ...
            <div slot="operator" class="operator-right">
                ...
                <a-button v-hasPermission="'log:delete'" @click="batchDelete">删除</a-button>
            ...
            <a-table ref="TableInfo"
                ...
                <template slot="method" slot-scope="text, record">
                    <a-popover placement="topLeft">
                        ...
                        <p style="margin-bottom: 0">{{text.substring(text.lastIndexOf(".")+1,text.length)}}</p>
                    </a-popover>
                </template>
                <template slot="params" slot-scope="text, record">
                    <a-popover placement="topLeft">
                        <template slot="content">
                            <div style="max-width: 600px">{{text}}</div>
                        </template>
                        <p style="margin-bottom: 0;">{{text.substring(0,25)}}</p>
                    </a-popover>
                </template>
            </a-table>
        </div>
...
<script>
    ...
    export default {
        name: 'SystemLog',
        components: {RangeDate,TableHeaderSearch},
        data() {
            return {
                advanced: false,
                dataSource: [],
